...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
    	...
    	if (compilationUnit instanceof TopLevelClass) {
    		...
    		if (topLevelClass.getJavaDocLines() != null && topLevelClass.getJavaDocLines().size() > 0) {
...
//                .addJavaDocLine(" * This class was generated by MyBatis Generator."); //$NON-NLS-1$
        sb.append(" * "); //$NON-NLS-1$
        String remarks = (String) introspectedTable.getAttribute("table_remarks");
        if (remarks != null && !remarks.equals("")) {
        	sb.append(introspectedTable.getAttribute("table_remarks"));
        	sb.append("，");
        }
        sb.append("对应数据库表 ");
